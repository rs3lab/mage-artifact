...
struct mn_status;
// XXX(yash): This is stored in private area of each VMA. Could be immensely useful.
...
struct mm_struct *mn_dup_mm(struct task_struct *new_tsk, struct task_struct *old_tsk, u16 sender_id);
...
int mn_populate_cache(u16 tgid, u16 pid_ns_id, u16 pid, unsigned long addr, unsigned long len, int nid,
					  unsigned long flags, vm_flags_t vm_flags, unsigned long *file);
unsigned long mm_do_mmap(struct task_struct *tsk, unsigned long addr,
						 unsigned long len, unsigned long prot, unsigned long flags, vm_flags_t vm_flags,
						 unsigned long pgoff, unsigned long *file, int nid, int need_cache_entry);
...
// brk
unsigned long mn_do_brk(struct task_struct *tsk, unsigned long addr, int nid);
...
mn_arch_get_unmapped_area_topdown(struct task_struct *, unsigned long *, unsigned long,
            unsigned long, unsigned long, unsigned long);
unsigned long
mn_arch_kern_get_unmapped_area(struct task_struct *tsk, const unsigned long len,
                               const unsigned long va_start, const unsigned long va_end);
unsigned long
mn_arch_kern_check_and_get_va(struct task_struct *tsk, unsigned long addr, const unsigned long len);
