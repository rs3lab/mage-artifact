...
void visit_type_BlockdevOptionsBlkdebug_members(Visitor *v, BlockdevOptionsBlkdebug *obj, Error **errp)
{
    ...
    if (visit_optional(v, "take-child-perms", &obj->has_take_child_perms)) {
        visit_type_BlockPermissionList(v, "take-child-perms", &obj->take_child_perms, &err);
        if (err) {
            goto out;
        }
    }
    if (visit_optional(v, "unshare-child-perms", &obj->has_unshare_child_perms)) {
        visit_type_BlockPermissionList(v, "unshare-child-perms", &obj->unshare_child_perms, &err);
        if (err) {
            goto out;
        }
    }
