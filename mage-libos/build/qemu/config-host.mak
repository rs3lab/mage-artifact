...
all:
prefix=/home/yupan/mage-artifact/mage-libos/build/qemu
bindir=${prefix}/bin
libdir=${prefix}/lib
...
libs_softmmu=-lpixman-1 -lnuma -lpng16 -lz  -lfdt -lpmem
GIT=git
GIT_SUBMODULES=
GIT_UPDATE=no
ARCH=x86_64
...
VERSION=4.2.1
PKGVERSION=
SRC_PATH=/home/yupan/mage-artifact/mage-libos/qemu
...
CONFIG_PARALLELS=y
CONFIG_SHEEPDOG=y
TOOLS=qemu-ga$(EXESUF) elf2dmp$(EXESUF) ivshmem-client$(EXESUF) ivshmem-server$(EXESUF) qemu-nbd$(EXESUF) qemu-img$(EXESUF) qemu-io$(EXESUF) qemu-edid$(EXESUF)  fsdev/virtfs-proxy-helper$(EXESUF) scsi/qemu-pr-helper$(EXESUF)
ROMS=optionrom
MAKE=make
INSTALL=install
...
QEMU_INCLUDES=-iquote $(SRC_PATH)/tcg -iquote $(SRC_PATH)/tcg/i386 -I$(SRC_PATH)/linux-headers -I/home/yupan/mage-artifact/mage-libos/build/qemu/linux-headers -iquote . -iquote $(SRC_PATH) -iquote $(SRC_PATH)/accel/tcg -iquote $(SRC_PATH)/include -I $(SRC_PATH)/../build/rdma-core/include
LDFLAGS=-Wl,--warn-common -Wl,-z,relro -Wl,-z,now -pie -m64 -g 
QEMU_LDFLAGS= 
LD_REL_FLAGS=-r
LD_I386_EMULATION=elf_i386
LIBS+=-lm -lz -lgthread-2.0 -pthread -lglib-2.0 
LIBS_TOOLS+=-lcap-ng 
PTHREAD_LIB=
EXESUF=
DSOSUF=.so
